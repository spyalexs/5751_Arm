...
void loop() {
  Serial.println("Please unplug servo");
  while(Serial.available()){}

  delay(1000);

  Serial.println("Please enter servo previous ID");
  while(Serial.available() == 0){}
  String prev_id = Serial.readString();

  delay(1000);

  Serial.println("Please enter servo new ID");
  while(Serial.available() == 0){}
  String new_id = Serial.readString();

  Serial.println("Please plug in servo within 10 seconds");

  Serial.print("Setting servo id: ");
  Serial.print(prev_id.toInt());
  Serial.print(" to: ");
  Serial.println(new_id.toInt());

  delay(10000);

  LobotSerialServoSetID(Serial, prev_id.toInt(), new_id.toInt());
}
